...
def searchBack(detected_peaks, unfiltered_ecg, search_samples):
    """
    detected_peaks: search for the peaks
    unfiltered_ecg: original ecg
    search_samples: 100
    """
    r_peaks = []
...
def panPeakDetect(detection, fs):
    """
    detection: after using nn.convolve of original ecg
    fs: 200ms
    """
    min_distance = int(0.25*fs)   # min_distance =50
    # with 50 window size, look for peaks and return indices of peaks
